...
export const MeasureTimeIntelligenceSchema = z.object({
  dateRefs: z
    ...
    .optional()
    .describe(
      'time-intelligence dateRefs: non-empty fact/source date column refs required when confirmed TI DAX is authored.',
    ),
  dateTable: NonEmptyString.optional().describe(
    'time-intelligence dateTable: governed Date table name required when confirmed TI DAX is authored.',
  ),
  dateColumn: NonEmptyString.optional().describe(
    'time-intelligence dateColumn: governed Date table key column required when confirmed TI DAX is authored.',
  ),
  ...
  grain: NonEmptyString.optional().describe(
    'time-intelligence grain: proven Date/fact grain required when confirmed TI DAX is authored.',
  ),
  calendarPolicy: NonEmptyString.optional().describe(
    'time-intelligence calendarPolicy: governed calendar range policy required when confirmed TI DAX is authored.',
  ),
  incompletePeriodBehavior: NonEmptyString.optional().describe(
    'time-intelligence incompletePeriodBehavior: explicit incomplete-period policy required when confirmed TI DAX is authored.',
  ),
});
