...
- **KPI comparisons must be verified** — use targets/gaps only when present in the model/spec or explicitly requested; otherwise render actual-only → `references/kpi-cards.md`
